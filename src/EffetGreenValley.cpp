...
void EffetGreenValley::equilibrerPieces(std::vector<Joueur*> joueurs) {
	...
	//resume
    std::cout << "Tous les joueurs possedent maintenant " << division << " piece(s)\n";
}
...
int EffetGreenValley::runEffect(Joueur* j1, std::vector<Joueur*> vectJoueur) {
	if (equilibrePieces) {
